...
const inputCls = "w-full border border-[#E7E0D8] bg-[#FAF8F5] px-3.5 py-2.5 text-sm text-[#111827] placeholder:text-[#C4B49A] rounded-lg focus:outline-none focus:border-[#E8793A] focus:ring-2 focus:ring-[#E8793A]/20 transition-all";
...
function Dashboard() {
  ...
  const openCreate = () => {
    setFormName(""); setFormUrl(""); setFormInterval("5");
    setFormError(null); setCreateOpen(true);
  };
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-[#FAF8F5]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-[#8C7B69] font-medium">Loading dashboard…</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="rounded-xl border border-[#EDE8E1] bg-white px-5 py-4 flex items-start justify-between hover:border-[#D4C4B0] transition-colors shadow-sm">
        <div className="min-w-0 flex-1">
          <p className="text-xs text-[#9C8E80] font-medium uppercase tracking-wider truncate">{label}</p>
          <p className="text-2xl font-bold text-[#1A1008] mt-1 leading-none">{value ?? "—"}</p>
          {sub && <p className="text-xs text-[#B0A090] mt-1.5 truncate">{sub}</p>}
        </div>
        <div className="ml-3 mt-0.5 shrink-0 text-lg text-[#C4B49A]">{icon}</div>
      </div>
    );
  }
  ...
  function SectionLabel({ children }) {
    return (
      <div className="flex items-center gap-3 mb-4">
        <span className="text-[11px] font-semibold text-[#9C8E80] uppercase tracking-widest">{children}</span>
    ...
    if (active && payload && payload.length) {
      return (
        <div className="rounded-lg border border-[#EDE8E1] bg-white px-3 py-2 shadow-lg">
          ...
          <p className="text-sm font-semibold text-[#E8793A]">{payload[0].value} ms</p>
        </div>
      );
    }
    return null;
  ...
  const navItems = [
    {
      label: "Dashboard", active: true, onClick: null,
      icon: (
    ...
    {
      label: "Monitors", active: false, onClick: () => navigate("/monitor"),
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
    ...
    },
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path d="M8 1.5C5.5 1.5 3.5 3.5 3.5 6v3L2 11h12l-1.5-2V6C12.5 3.5 10.5 1.5 8 1.5z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
          <path d="M6.5 11v.5a1.5 1.5 0 003 0V11" stroke="currentColor" strokeWidth="1.4"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M4 8.5h8M4 11h5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M6.5 8H9.5M6.5 7L9.5 4.5M6.5 9L9.5 11.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/>
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M8 1v1.5M8 13.5V15M15 8h-1.5M2.5 8H1M12.7 3.3l-1.06 1.06M4.36 11.64l-1.06 1.06M12.7 12.7l-1.06-1.06M4.36 4.36L3.3 3.3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
        </svg>
      ),
    },
  ];
  ...
  return (
    <div className="flex h-screen bg-[#F5F1EA] text-[#1A1008] overflow-hidden font-sans">
      ...
      {/* ── SIDEBAR ── */}
      <aside className="w-47.5 shrink-0 border-r border-[#EDE8E1] bg-white flex flex-col">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Header */}
        <header className="h-15 shrink-0 border-b border-[#EDE8E1] bg-white flex items-center justify-between px-7">
          <div>
            <h1 className="text-[15px] font-bold text-[#1A1008]">Dashboard</h1>
            <p className="text-xs text-[#9C8E80]">Here's what's happening with your monitors.</p>
          </div>
          <div className="flex items-center gap-3">
            <div className="hidden md:flex items-center gap-2 text-xs text-[#9C8E80] font-mono bg-[#F5F1EA] border border-[#EDE8E1] px-3 py-1.5 rounded-lg">
        ...
        {/* Scrollable content */}
        <main className="flex-1 overflow-y-auto px-7 py-6 space-y-6 bg-[#F5F1EA]">

          {/* Status banner */}
          <div className="flex items-center justify-between bg-white border border-[#EDE8E1] rounded-xl px-5 py-3 shadow-sm">
            <div className="flex items-center gap-2.5">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-green-500" />
              </span>
              <span className="text-sm text-[#3C3028] font-medium">All systems operational</span>
              <span className="text-[#B0A090] text-sm">·</span>
              <span className="text-sm text-[#9C8E80]">
                {data.UpTimePercentage ? `${data.UpTimePercentage}% uptime` : "99.97% uptime"}
              </span>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <StatCard
                ...
                icon={
                  <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                    <rect x="1" y="2" width="14" height="10" rx="1.5" stroke="#E8793A" strokeWidth="1.4"/>
                    <path d="M5 14h6M8 12v2" stroke="#E8793A" strokeWidth="1.4" strokeLinecap="round"/>
                  </svg>
                }
              />
              <StatCard
                ...
                icon={
                  <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                    ...
                    <path d="M5 8l2.2 2.2L11 5.5" stroke="#22C55E" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                }
              />
              <StatCard
              ...
              <StatCard
                ...
                icon={
                  <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                    <circle cx="8" cy="8" r="6.5" stroke="#E8793A" strokeWidth="1.4"/>
                    <path d="M8 4.5V8l2 2" stroke="#E8793A" strokeWidth="1.5" strokeLinecap="round"/>
                  </svg>
                }
              />
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
            <StatCard
              ...
              icon={
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                  <polyline points="1,10 3.5,10 5,5 7,13 9,7 11,10 13,10 15,10" stroke="#E8793A" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                </svg>
              }
            />
            <StatCard
              ...
              icon={
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                  <path d="M3 11L7 7L9.5 9.5L13 5" stroke="#22C55E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              }
            />
            <StatCard
              label="Last Check"
              value={data.LastCheck ? new Date(data.LastCheck).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "—"}
              sub={data.LastCheck ? new Date(data.LastCheck).toLocaleDateString() : "No data"}
              icon={
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                  <circle cx="8" cy="8" r="6.5" stroke="#E8793A" strokeWidth="1.4"/>
                  <path d="M8 4.5V8l2 2" stroke="#E8793A" strokeWidth="1.5" strokeLinecap="round"/>
            ...
            <StatCard
              ...
              sub={data.fastestMonitor?.responseTime ? `${data.fastestMonitor.responseTime} ms` : "No data"}
              icon={
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                  <path d="M8 2L9.5 6H14L10.5 8.5L12 13L8 10.5L4 13L5.5 8.5L2 6H6.5L8 2Z" stroke="#F59E0B" strokeWidth="1.3" strokeLinejoin="round"/>
                </svg>
              }
            />
            <StatCard
              ...
              sub={data.slowestMonitor?.responseTime ? `${data.slowestMonitor.responseTime} ms` : "No data"}
              icon={
                <svg width="20" height="20" viewBox="0 0 16 16" fill="none">
                  <path d="M8 3l-.01 7" stroke="#EF4444" strokeWidth="1.5" strokeLinecap="round"/>
          ...
          <div className="grid lg:grid-cols-[1fr_280px] gap-4">
            ...
            <div className="rounded-xl border border-[#EDE8E1] bg-white p-6 shadow-sm">
              <div className="flex items-start justify-between mb-5">
                <div>
                  <p className="text-sm font-semibold text-[#1A1008]">Response Time</p>
                  <p className="text-xs text-[#9C8E80] mt-0.5">Average response time across all monitors</p>
                </div>
                <span className="text-xs font-mono text-[#9C8E80] bg-[#F5F1EA] border border-[#EDE8E1] px-2.5 py-1 rounded-lg">24h</span>
              </div>
              <ResponsiveContainer width="100%" height={200}>
                <AreaChart data={responseTimeData} margin={{ top: 4, right: 4, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="rtGrad" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%"  stopColor="#E8793A" stopOpacity={0.18} />
                  ...
                  <Area
                    ...
                    fill="url(#rtGrad)"
                    dot={false}
                    activeDot={{ r: 4, fill: "#E8793A", stroke: "#fff", strokeWidth: 2 }}
                  />
                </AreaChart>
              </ResponsiveContainer>
            </div>
            ...
            {/* Status donut */}
            <div className="rounded-xl border border-[#EDE8E1] bg-white p-6 shadow-sm">
              <p className="text-sm font-semibold text-[#1A1008] mb-0.5">Status Overview</p>
              <p className="text-xs text-[#9C8E80] mb-4">Current status distribution</p>
              ...
              <div className="space-y-2.5 mt-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-[#1A1008]">
                    {up}{" "}
                    <span className="text-[#B0A090] font-normal text-xs">({Math.round((up / total) * 100)}%)</span>
                  </span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="flex items-center gap-2 text-[#3C3028]">
                  ...
                  <span className="font-semibold text-[#1A1008]">
                    {down}{" "}
                    <span className="text-[#B0A090] font-normal text-xs">({Math.round((down / total) * 100)}%)</span>
                  </span>
                </div>
              </div>
            </div>
      ...
      {createOpen && (
        <Modal onClose={() => setCreateOpen(false)} title="Create Monitor" subtitle="Start monitoring a new endpoint.">
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            {formError && (
              <p className="text-xs text-red-500 bg-red-50 border border-red-100 px-3 py-2 rounded-lg">{formError}</p>
            )}
